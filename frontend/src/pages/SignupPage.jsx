  ...
  return (
    <div className="min-h-screen flex items-center justify-center gradient-bg p-4 animate-gradient relative overflow-hidden">
      ...
      >
        ...
        {error && (
          <div className="bg-red-100 dark:bg-red-900/30 border-l-4 border-red-500 text-red-700 dark:text-red-400 p-4 mb-6 rounded-lg">
        ...
        <div className="mt-6 text-center">
          <p className="text-gray-600 dark:text-gray-400 text-sm">
            ...
            <a href="/" className="font-bold gradient-text hover:underline">
              Login here! 🚀
            </a>
          </p>
        </div>
